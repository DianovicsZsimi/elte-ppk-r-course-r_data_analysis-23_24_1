...
cocktaildata <- cocktaildata |> 
  separate_wider_delim(ingredients, delim = "<br/>",
                       names = c("ingredient1", "ingredient2", "ingredient3", "ingredient4", "ingredient5", "ingredient6"),
                       too_few = "align_start",
                       
  )

cocktaildata <- cocktaildata %>%
  mutate(ingredient1 = gsub("^\\d+\\s*\\d*/\\d*\\s*oz\\s*|\\b\\d+[/.]?\\d*\\s*oz\\b|\\b\\d+[/.]?\\d*\\s*abv\\b|\\(.*?\\)", "", ingredient1),
         ingredient1 = trimws(ingredient1))
